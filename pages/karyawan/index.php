                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-lg-8">
                                            ...
                                            <p class="card-description"> Tabel Karyawan menampilkan data diri karyawan secara lengkap, seperti nama, umur, kontak, dan informasi lainnya, guna memudahkan pencatatan, identifikasi, serta pengelolaan sumber daya manusia dalam perusahaan.
                                            </p>
                                        </div>
                                        <div class="col-lg-4" style="float:right;">
                                            <button class="btn btn-gradient-primary btn-rounded btn-fw" type="button" onclick="tambahData()"><i class="fa fa-plus"></i> Tambah Karyawan</button>
                                        </div>
                                    </div>
                                    <table class="table table-striped" id="striped-table">
                                        ...
                                        <tbody>
                                            ...
                                            while ($supplier = mysqli_fetch_array($result)) {
                                                ...
                                                echo "<td>" . $supplier['Jenis_Kelamin'] . "</td>";
                                                $tanggalLahir = new DateTime($supplier['Tanggal_Lahir']);
                                                $sekarang = new DateTime();
                                                $selisih = $sekarang->diff($tanggalLahir);
                                                ...
                                                echo "<button class='btn btn-xs btn-outline-danger btn-fw padding-button' onclick='hapus_data(" . $supplier['ID_Karyawan'] . ")' ><i class='fa fa-edit'></i> Hapus</button>";
                                                echo "</td>";
                                            }
                                            ?>
                                        </tbody>
